...
function update_forecast(data){
    ...
    <div class="other">
        ...
        <div class="temp">High Temp - ${data.forecast.forecastday[0].day.maxtemp_c} &#176; C</div>
        <div class="temp">Low Temp - ${data.forecast.forecastday[0].day.mintemp_c} &#176; C</div>
    </div>`
    var t1=(t===6)?-1:t
    day2.innerHTML=
    ...
    <div class="other">
        ...
        <div class="temp">High Temp - ${data.forecast.forecastday[1].day.maxtemp_c} &#176; C</div>
        <div class="temp">Low Temp - ${data.forecast.forecastday[1].day.mintemp_c} &#176; C</div>
    </div>`
    var t2=t
    if (t===5){
        t2=-2
    ...
    <div class="other">
        ...
        <div class="temp">High Temp - ${data.forecast.forecastday[2].day.maxtemp_c} &#176; C</div>
        <div class="temp">Low Temp - ${data.forecast.forecastday[2].day.mintemp_c} &#176; C</div>
    </div>`
}
